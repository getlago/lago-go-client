...
var mockWalletTransactionListResponse = `{
			"wallet_transactions": [{
				...
				"lago_invoice_id": "d1d2e3e4-f5f6-7890-1234-56789abcdef0",
				"lago_credit_note_id": "e1e2f3f4-a5b6-7890-1234-56789abcdef0",
			...
			WalletTransactions: []WalletTransaction{
				{
					...
					LagoInvoiceID:                    Ptr(uuid.MustParse("d1d2e3e4-f5f6-7890-1234-56789abcdef0")),
					LagoCreditNoteID:                 Ptr(uuid.MustParse("e1e2f3f4-a5b6-7890-1234-56789abcdef0")),
